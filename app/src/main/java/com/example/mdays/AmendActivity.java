...
public class AmendActivity extends BaseActivity implements View.OnClickListener{
    ...
    void init(){
        DBOpenHelper = new DBOpenHelper(this,"mday.db",null,1);
        ...
        if (intent!=null){
            ...
            record.setId(Integer.valueOf(intent.getStringExtra(DBOpenHelper.RECORD_ID)));
            record.setTitleName(intent.getStringExtra(DBOpenHelper.RECORD_TITLE));
            record.setTextBody(intent.getStringExtra(DBOpenHelper.RECORD_BODY));
            record.setCreateTime(intent.getStringExtra(DBOpenHelper.RECORD_TIME));
            record.setNoticeTime(intent.getStringExtra(DBOpenHelper.NOTICE_TIME));
    ...
    boolean updateFunction(String body){
        ...
        if(flag){
            ...
            values.put(DBOpenHelper.RECORD_TIME,getNowTime());
            db.update(DBOpenHelper.TABLE_NAME_RECORD,values,DBOpenHelper.RECORD_ID +"=?",
