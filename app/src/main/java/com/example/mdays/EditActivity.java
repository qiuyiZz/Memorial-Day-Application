...
import com.example.mdays.util.MyFormat;
import com.example.mdays.util.MyTimeGetter;

import java.util.Date;

import static com.example.mdays.util.MyFormat.getTimeStr;
...
public class EditActivity extends BaseActivity implements View.OnClickListener,
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            if (!isShowIng()){
                if (!"".equals(title)||!"".equals(body)){
                    showDialog(title,type,body,createDate);
                    clearDialog();
                } else {
                    intentStart();
                }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.button_save:
                if (saveFunction(title,type,body,createDate)){
                    intentStart();
                }
                break;
     ...
     * 备忘录保存函数
     */
    boolean saveFunction(String title, String type,String body, String createDate){
        ...
        if(flag){
            ...
            values.put(DBOpenHelper.RECORD_TITLE,title);
            values.put(DBOpenHelper.RECORD_TYPE,type);
            values.put(DBOpenHelper.RECORD_BODY,body);
            values.put(DBOpenHelper.RECORD_TIME,createDate);
            if (timeSetTag){
                //  为当前备忘录添加提醒
                ...
                values.put(DBOpenHelper.NOTICE_TIME,str);
            }
            db.insert(DBOpenHelper.TABLE_NAME_RECORD,null,values);
     ...
     * @param createDate
     */
    void showDialog(final String title,final String type, final String body, final String createDate){
        ...
        dialog.setPositiveButton("保存",
            ...
            public void onClick(DialogInterface dialog, int which) {
                saveFunction(title,type, body, createDate);
                intentStart();
                    }
                });
